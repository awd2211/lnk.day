...
import {
  RABBITMQ_CONNECTION,
  RABBITMQ_CHANNEL,
  PAGE_EVENTS_EXCHANGE,
} from './rabbitmq.constants';

export { RABBITMQ_CONNECTION, RABBITMQ_CHANNEL, PAGE_EVENTS_EXCHANGE };
...
@Module({
    ...
    },
    {
      ...
      useFactory: async (connection: any) => {
        ...
        try {
          ...
          await channel.assertExchange(PAGE_EVENTS_EXCHANGE, 'topic', {
            durable: true,
          });
  ...
  exports: [RABBITMQ_CONNECTION, RABBITMQ_CHANNEL, PageEventService],
})
