    ...
    const link = await this.linkService.create(
      {
        ...
        geoTargeting: template.defaultGeoTargeting,
        deviceTargeting: template.defaultDeviceTargeting,
        timeTargeting: template.defaultTimeTargeting,
        passwordProtected: template.defaultPasswordProtected,
