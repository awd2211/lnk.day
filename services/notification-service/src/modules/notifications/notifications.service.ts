  ...
  private getDefaultTemplates(): Partial<NotificationTemplate>[] {
    return [
      ...
      },
      {
        ...
        type: 'email' as any,
        category: 'account',
        subject: '检测到可疑活动 - {{appName}}',
        content: '亲爱的 {{userName}}，\n\n我们检测到您的账户存在可疑活动：\n\n时间：{{loginTime}}\n设备：{{deviceInfo}}\n位置：{{location}}\nIP地址：{{ipAddress}}\n\n如果这不是您本人的操作，请立即修改密码并启用两步验证。\n\n{{appName}} 团队',
        variables: ['userName', 'loginTime', 'deviceInfo', 'location', 'ipAddress', 'appName'],
        description: '可疑活动安全警报',
        isSystem: true,
        isActive: true,
      },
      ...
      // ===== 隐私合规类 (Privacy) =====
      {
        ...
        content: '您好 {{userName}}，\n\n您请求的数据导出已准备就绪。\n\n下载链接：{{downloadUrl}}\n\n此链接将在 {{expiresIn}} 后失效，请及时下载。\n\n{{appName}} 团队',
        variables: ['userName', 'downloadUrl', 'expiresIn', 'appName'],
        description: '数据导出完成通知',
        isSystem: true,
        isActive: true,
      },
      {
        ...
        content: '您好 {{userName}}，\n\n我们已收到您的隐私请求。\n\n请求类型：{{requestType}}\n预计处理日期：{{scheduledDate}}\n冷却期：{{coolingPeriod}}天\n\n在冷却期内，您可以随时取消此请求。\n\n{{appName}} 团队',
        variables: ['userName', 'requestType', 'scheduledDate', 'coolingPeriod', 'appName'],
        description: '隐私请求确认（如账户删除）',
        isSystem: true,
        isActive: true,
      },
      {
        name: '账户删除警告',
        code: 'account_deletion_warning',
        type: 'email' as any,
        category: 'privacy',
        subject: '账户删除提醒 - 还有{{daysRemaining}}天 - {{appName}}',
        content: '您好 {{userName}}，\n\n您的账户删除请求将在 {{daysRemaining}} 天后执行。\n\n届时，您的所有数据将被永久删除，包括：\n- 所有链接及其统计数据\n- 团队和成员信息\n- 自定义域名配置\n- 账户设置\n\n如需取消，请访问：{{cancelUrl}}\n\n{{appName}} 团队',
        variables: ['userName', 'daysRemaining', 'cancelUrl', 'appName'],
        description: '账户即将删除的倒计时提醒',
        isSystem: true,
        isActive: true,
      },
      {
        ...
        type: 'email' as any,
        category: 'privacy',
        subject: '您的账户已删除 - {{appName}}',
        content: '您好 {{userName}}，\n\n您的 {{appName}} 账户已成功删除，所有相关数据已被永久清除。\n\n感谢您曾经使用我们的服务。如果将来有需要，欢迎随时重新注册。\n\n{{appName}} 团队',
        variables: ['userName', 'appName'],
        description: '账户删除完成通知',
        isSystem: true,
        isActive: true,
      },
